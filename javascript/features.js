...
// function transactionHistory(para,params) {
//   const donationInput = document.getElementById(para).value;
//   const date = new Date();

//   const historyDiv = document.createElement('div');
//   historyDiv.classList.add('w-full', 'h-auto', 'p-8', 'mb-6', 'rounded-2xl', 'bg-white', 'border', 'border-[#111111]/10');
//   historyDiv.innerHTML = `
//     <h3 class="mb-3 text-xl font-bold text-[#111111]">${donationInput} Taka is Donated for ${params}, Bangladesh</h3>
//     <p class="text-base font-light text-[#111111]/70">Date : ${date.toString()}</p>
//   `
//   document.getElementById('history-section').prepend(historyDiv);
...
function showSection(sectionId) {
  ...
  // document.getElementById("btn-donation-section").classList.add("bg-transparent");
  // document.getElementById("btn-history-section").classList.add("bg-transparent");
  // document.getElementById(sectionId).classList.remove("bg-[#B4F461]");
